            ...
            <div key={image.id} className="group relative overflow-hidden rounded-lg shadow-lg aspect-square">
              ...
              {onDeleteImage && (
                <button
                  ...
                  className="absolute top-2 right-2 p-2 bg-red-600/90 hover:bg-red-500 text-white rounded-md transition-all duration-200 opacity-0 group-hover:opacity-100 shadow-lg hover:scale-110 z-10"
